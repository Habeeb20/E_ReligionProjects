      ...
      try {
        ...
        if (response.data.status && Array.isArray(response.data.data)) {
          ...
          const islamMinisters = response.data.data.filter(
            minister => minister.religion && minister.religion.toLowerCase() === 'traditional'
          );
    ...
    <div className="bg-gray-100 min-h-screen py-12 px-4 md:px-8">
      <div className="max-w-7xl mx-auto text-center mb-12">
        ...
        <p className="text-lg md:text-xl text-gray-600">
          Connect with Islamic Servants of God on a click
        </p>
      </div>

      <div className="flex justify-between items-center mb-8">
        <h2 className="text-2xl font-semibold text-gray-800">Related Islamic Leaders around you</h2>
