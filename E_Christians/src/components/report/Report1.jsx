...
const Report1 = () => {
  return (
    <div className="flex mt-10 flex-col items-center bg-yellow-50 py-10 min-h-screen mt-5">
      {/* Header Section */}
      <h1 className="text-3xl mt-10 md:text-4xl font-bold text-blue-900 mb-4 text-center">
