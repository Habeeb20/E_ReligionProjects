...
const MostViewedListing = () => {
  ...
  useEffect(() => {
    const fetchListings = async () => {
      try {
        ...
        setListings(response.data.data.mostViewedListings || []);
      } catch (error) {
        console.error('Error fetching most viewed listings:', error);
      }
    };
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-4 text-gray-800">Most Viewed Listings</h2>
...
export default MostViewedListing;