...
import re from '../../assets/religion/church1.jpeg';
import im2 from '../../assets/religion/St.jpeg';
import im3 from '../../assets/religion/church2.jpeg';
const Religion3 = () => {
  return (
    <div className="bg-gray-100 min-h-screen py-10 px-4">
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 mb-8">
          <h2 className="text-3xl font-bold text-indigo-800 mb-4">Christians</h2>
